      ...
      <section className="max-w-frame mx-auto bg-[#F0F0F0] px-6 pb-6 pt-10 md:p-[70px] rounded-[40px] text-center">
        ...
        >
          <DressStyleCard
            title="Fruits "
            url="/shop#fruit"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/pic6.jpg')]"
          />
          <DressStyleCard
            title="Céréales"
            url="/shop#cereal"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/pic8.jpg')]"
          />
        </motion.div>
        <motion.div
          initial={{ y: "100px", opacity: 0 }}
        ...
        >
          <DressStyleCard
            title="Tubercules"
            url="/shop#tubercule"
            className="md:max-w-[684px] h-[190px] bg-[url('/images/pic9.png')]"
          />
          <DressStyleCard
            title="Miel"
            url="/shop#miel"
            className="md:max-w-[260px] lg:max-w-[360px] xl:max-w-[407px] h-[190px] bg-[url('/images/pic1.jpg')]"
          />
        </motion.div>
      </section>
    </div>
