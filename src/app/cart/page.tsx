      ...
      <div className="max-w-frame mx-auto px-4 xl:px-0">
        {cart && cart.items.length > 0 ? (
              ...
              <div className="w-full lg:max-w-[505px] p-5 md:px-6 flex-col space-y-4 md:space-y-6 rounded-[20px] border border-black/10">
                ...
                <div className="flex flex-col space-y-5">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="md:text-xl font-bold">{totalPrice}FCFA</span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="md:text-xl font-bold text-red-600">
                      -{Math.round(totalPrice - adjustedTotalPrice)}FCFA
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="md:text-xl text-black/60">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xl md:text-2xl font-bold">
                      {Math.round(adjustedTotalPrice)}FCFA
                    </span>
                  </div>
                </div>
          ...
          <div className="flex items-center flex-col text-gray-300 mt-32">
            ...
            <span className="block mb-4">Votre panier agricol est vide.</span>
            <Button className="rounded-full w-24" asChild>
              <Link href="/shop">Acheter ici</Link>
            </Button>
          </div>
        )}
      </div>
